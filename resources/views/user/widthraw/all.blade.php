...
@section('cart')
    <div class="d-flex justify-content-between align-items-center">
        <h1 class="fw-500 mb-3">Transcation</h1>
    </div>
@endsection
...
@section('content')
    <section class="matchboard mx-3 position-relative">
        <ul class="nav nav-pills my-3 d-flex justify-content-between" id="pills-tab" role="tablist">
            ...
            <li class="nav-item" role="presentation">
                <button class="nav-link" id="pills-profile-tab" data-bs-toggle="pill" data-bs-target="#" type="button"
        ...
        <div class="tab-content" id="pills-tabContent">
            @forelse ($user_transcations as $transcation)
                <div class="tab-pane fade show active" id="{{ $transcation->status }}" role="tabpanel"
