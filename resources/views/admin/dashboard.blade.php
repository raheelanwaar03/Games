            ...
            <div class="row invoice-card-row">
                <div class="col-xl-3 col-xxl-3 col-sm-6">
                    <div class="card bg-warning invoice-card">
                        <div class="card-body d-flex">
                            ...
                            <div>
                                <h2 class="text-white invoice-num">{{ totalUsers() }}</h2>
                ...
                <div class="col-xl-3 col-xxl-3 col-sm-6">
                    <div class="card invoice-card">
                        <div class="card-body d-flex">
                            <div>
                                <a href="{{ route('Admin.Daily.Bounce') }}" class="btn btn-sm btn-success">Daily Bounce</a>
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="card bg-info invoice-card">
                        <div class="card-body d-flex">
                            ...
                            <div>
                                ...
                                <span class="text-white fs-18">Rejected Users</span>
                            </div>
                        </div>
                    </div>
                </div>
                <div class="col-xl-3 col-xxl-3 col-sm-6">
                    <div class="card bg-secondary invoice-card">
                        <div class="card-body d-flex">
                            ...
                            <div>
                                <h2 class="text-white invoice-num">@</h2>
                                <span class="text-white fs-18">Pending Users</span>
                            </div>
                        </div>
                    </div>
                </div> --}}
